...
export default () => (
  <footer className="bg-[#231f38]-bg-opacity-40-pt-10 mt-12">
    <div className={"mx-auto max-w-7xl px-5 py-5 lg:py-10 grid grid-cols-3"}>
      <div className="space-y-8 col-span-12 lg:col-span-1 justify-center items-center lg:items-start flex flex-col">
        <Link href={"/"}>
        ...
        <div className="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div className="mt-12 md:mt-0">
            ...
            <ul role="list" className="mt-4 space-y-4">
              <li>
                <a
                  href="https://forms.gle/jypcaJgvPgrkYmRDA"
                  target="_blank"
                  className="text-base  hover:"
                >
                  Apply for IDO
    ...
    <div className="py-10">
      <div className="mx-auto max-w-7xl px-5 grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-0 lg:text-base text-sm">
        ...
        <p className="flex-1 lg:text-right text-center">
          Build with
          <svg
            className="w-5 h-5 text-purple-2 mb-1 inline mx-2"
            fill="currentColor"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
          >
