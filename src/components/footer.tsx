...
const Footer = () => (
	<footer className="bg-[#231f38]-bg-opacity-40">
		<div className={"mx-auto max-w-7xl px-5 py-5 lg:py-10 grid grid-cols-3"}>
			...
			<div className="mt-12 grid-cols-2 hidden lg:grid gap-8 xl:mt-0 lg:col-span-2 xl:col-span-2 text-right">
				<div className="md:grid md:grid-cols-2 md:gap-8">
					<div>
						<h3 className="text-sm font-bold text-gray-300 tracking-wider uppercase">About
							Parasol</h3>
						<ul role="list" className="mt-4 space-y-4">
							<li>
								<a href="#features" className="text-base hover:text-gray-300">Introducing
									Parasol</a>
							</li>
							<li>
					...
					<div className="mt-12 md:mt-0">
						...
						<ul role="list" className="mt-4 space-y-4">
							...
							<li>
								<a href="/whitepaper.pdf" className="text-base hover:text-gray-300">White
									Paper</a>
							</li>
							<li>
							...
							<li>
								<a href="https://app.parasol.finance/" target="_blank"
								   className="text-base hover:text-gray-300">Open Application</a>
							</li>
						</ul>
					</div>
				</div>
				<div className="md:grid md:grid-cols-2 md:gap-8">
					<div>
						...
						<ul role="list" className="mt-4 space-y-4">
							...
							<li>
								<a href="https://medium.com/@parasol.finance"
					...
					<div className="mt-12 md:mt-0">
						...
						<ul role="list" className="mt-4 space-y-4">
							<li>
								<a href="mailto:contact@parasol.finance" className="text-base hover:text-gray-300">Contact
									Us</a>
							</li>
							<li>
								<a href="#" className="text-base hover:text-gray-00">Terms of Service</a>
							</li>
							<li>
								<a href="#" className="text-base hover:text-gray-300">Privacy Policy</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<div className="py-10">
			<div
				...
				<p className="flex-1 lg:text-right text-center">
					Build with
					<svg className="w-5 h-5 text-purple-2 mb-1 inline mx-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						<path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
					</svg>
					in Europe, Enjoy Fork, We believe in open-source.
				</p>
			</div>
		</div>
	</footer>);
