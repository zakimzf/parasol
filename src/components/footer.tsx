  ...
  <footer className="bg-[#231f38]-bg-opacity-40-pt-10 mt-12">
    ...
    <div className="py-10">
      <div
        ...
        <p className="flex flex-1 items-center gap-x-3 justify-end lg:text-right text-center">
          <div>
            Build with
          ...
          <span>|</span>
          <a className={"inline-flex justify-center items-center gap-x-1"} href={"https://github.com/parasol-finance/application"} target={"_blank"} rel={"noreferrer"}>
          ...
          <span>|</span>
          <div>
            Crafted by <a href={"https://twitter.com/thisisclint21"} className={"font-medium"} target={"_blank"} rel={"noreferrer"}>Clint ⚡️</a>
          </div>
        </p>
      </div>
    </div>
