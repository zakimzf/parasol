    ...
    <div className="mx-auto max-w-7xl px-5 text-center">
      ...
      <div className="mt-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="pt-6">
            <div
              className="flow-root bg-[#231f38] bg-opacity-50 text-gray-300 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 rounded-lg px-6 pb-8">
              <div className="-mt-6">
                <div>
                  <span
                    className="inline-flex items-center justify-center p-3 bg-purple-2 rounded-md shadow-lg">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"><path
                        d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" /></svg>
                  </span>
                </div>
                <h3 className="mt-8 text-lg font-medium text-white tracking-tight">Governance</h3>
                <p className="mt-5 text-base">
                  With the unique Parasol system, the community decides which projects are put
                  forward and can
                  participate.
                </p>
              </div>
          ...
          <div className="pt-6">
            <div
              className="flow-root bg-[#231f38] bg-opacity-50 hover:bg-purple-2 text-gray-300 hover:text-gray-100 rounded-lg px-6 pb-8">
              <div className="-mt-6">
                <div>
                  <span
                    className="inline-flex items-center justify-center p-3 bg-purple-2 rounded-md shadow-lg">
                    <svg className="h-6 w-6" viewBox="0 0 96 84" fill="none"
                ...
                <h3 className="mt-8 text-lg font-medium text-white tracking-tight">Built on
                  Solana</h3>
                <p className="mt-5 text-base">
          ...
          <div className="pt-6">
            <div
              className="flow-root bg-[#231f38] bg-opacity-50 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 text-gray-300 hover:text-gray-100 rounded-lg px-6 pb-8">
              <div className="-mt-6">
                <div>
                  <span
                    className="inline-flex items-center justify-center p-3 bg-purple-2 rounded-md shadow-lg">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas"
                      data-icon="umbrella-beach" className="h-6 w-6 text-white" role="img"
                ...
                <h3 className="mt-8 text-lg font-medium text-white tracking-tight">Parasol Token
                  (PSOL)</h3>
                <p className="mt-5 text-base">
                  Parasol token owners will be able to participate in projects, you will have to
                  hold your
                  tokens for about 6 months.
                </p>
              </div>
            </div>
          </div>
