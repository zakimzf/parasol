export default () => (
  <section className="mt-64 mb-20 py-15 lg:mt-10">
    <div className="mx-auto max-w-7xl px-5 text-center">
      <h2 className="text-base font-semibold tracking-wider text-purple-400 uppercase">
        Discover Parasol
      </h2>
      <a
        id="features"
      ...
      <p className="mt-5 max-w-prose mx-auto text-sm lg:text-base text-gray-200">
        Parasol Finance is the first community governed IDO platform built on
        Solana.
      </p>
      <div className="mt-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="pt-6">
            <div className="flow-root bg-[#231f38] bg-opacity-50 text-gray-300 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 rounded-lg px-6 pb-8">
              <div className="-mt-6">
                <div>
                  <span className="inline-flex items-center justify-center p-3 bg-purple-2 rounded-md shadow-lg">
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                ...
                <p className="mt-5 text-base">
                  With the unique Parasol system, the community decides which
                  projects are put forward and can participate.
                </p>
              </div>
            </div>
          </div>
          <div className="pt-6">
            <div className="flow-root bg-[#231f38] bg-opacity-50 hover:bg-purple-2 text-gray-300 hover:text-gray-100 rounded-lg px-6 pb-8">
              <div className="-mt-6">
                <div>
                  <span className="inline-flex items-center justify-center p-3 bg-purple-2 rounded-md shadow-lg">
                    <svg
                ...
                <p className="mt-5 text-base">
                  With Solana you enjoy low fees and fast transaction and
                  flexibility. Explore our token on explorer{" "}
                  <a
          ...
          <div className="pt-6">
            <div className="flow-root bg-[#231f38] bg-opacity-50 hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 text-gray-300 hover:text-gray-100 rounded-lg px-6 pb-8">
              <div className="-mt-6">
                <div>
                  <span className="inline-flex items-center justify-center p-3 bg-purple-2 rounded-md shadow-lg">
                    <svg
                ...
                <p className="mt-5 text-base">
                  Parasol token owners will be able to participate in projects,
                  you will have to hold your tokens for about 6 months.
                </p>
              </div>
            </div>
          </div>
