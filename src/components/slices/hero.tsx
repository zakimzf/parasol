      ...
      <div className="col-span-12 lg:col-span-6 text-center lg:text-left lg:flex lg:items-center">
        <div className="pb-3">
          ...
          <h1 className="mt-4 text-3xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-7 lg:text-4xl xl:text-6xl">
            ...
            <span className="text-transparent bg-clip-text bg-purple-2 leading-normal whitespace-nowrap md:block">
          ...
          <div className="mt-8 grid lg:flex gap-3 grid-cols-1 lg:grid-cols-2 justify-start">
            <Link href={"/projects"}>
              <a className="flex items-center justify-center gap-x-2 px-10 bg-purple-2 py-3 text-base font-medium rounded-lg shadow-lg text-white bg-gradient-primary hover:from-pink-600 hover:to-purple-500">
                <CollectionIcon className={"w-5 h-5"} />
                View Upcoming IDOs
              </a>
            </Link>
            <Link href={"/swap"}>
              <a className="flex items-center justify-center gap-x-2 px-7 py-3 text-base font-medium border border-white hover:bg-white hover:text-purple-600 rounded-lg shadow-lg text-white hover:to-purple-500">
                <svg
                  className="w-5 h-5"
                  xmlns="http://www.w3.org/2000/svg"
