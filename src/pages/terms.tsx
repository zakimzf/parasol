		...
		<>
			<div className="relative pt-6  overflow-hidden">
				<div className="relative px-4 sm:px-6 lg:px-8">
					<div className="text-lg max-w-prose py-10 mx-auto">
						<h1>
							<span className="block text-base text-center text-purple-2 font-semibold tracking-wide uppercase">Introducing</span>
							<span className="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-200 sm:text-4xl">Terms of Service</span>
						</h1>
						<p className="mt-8 text-xl text-gray-300 leading-8">Aliquet nec orci mattis amet quisque
					...
					<div className="text-lg mt-6 max-w-prose mx-auto text-gray-300">
