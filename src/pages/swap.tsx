	...
	return <>
		<section className="pt-10 pb-20">
			<div className="flex flex-col gap-y-6 max-w-md mx-auto mt-6 ">
				<div className="bg-[#231f38] text-gray-100 px-5 py-6 sm:p-8 shadow-lg rounded-xl">
					<div className={"flex justify-between items-end mb-4"}>
						...
						<div className="flex gap-x-2 items-center text-xs font-medium">
							...
							<button className={"bg-gray-500 text-[9px] bg-opacity-50 uppercase font-bold text-gray-400 px-2 py-[2px] rounded-full hover:bg-opacity-30"}>Half</button>
							<button className={"bg-gray-500 text-[9px] bg-opacity-50 uppercase font-bold text-gray-400 px-2 py-[2px] rounded-full hover:bg-opacity-30"}>Max</button>
						</div>
					</div>
					<div className="flex justify-between items-stretch bg-white bg-opacity-5 rounded-xl px-4 py-3">
						<button type="button" className="flex gap-x-2 py-2 px-2 rounded-lg flex items-center hover:bg-gray-500 hover:bg-opacity-10">
							<img className="w-5 h-5 rounded-full" alt="USDC" src="https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v/logo.png" />
					...
					<svg className={"mx-auto h-4 mt-5 mb-2 text-gray-300"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						<path d="M19.3,13.1a.7.7,0,0,1,.5,1.192l-5.427,5.5a.7.7,0,1,1-1-.983L17.626,14.5H.7a.7.7,0,0,1,0-1.4ZM6.62.2a.7.7,0,0,1,.007.99L2.374,5.5H19.3a.7.7,0,0,1,0,1.4H.7A.7.7,0,0,1,.2,5.711L5.63.208A.7.7,0,0,1,6.62.2Z" fill="currentColor" />
					</svg>
					<div className={"flex justify-between items-end mb-4"}>
					...
					<div className="flex justify-between items-center py-3">
						<button type="button" className="flex gap-x-2 px-4 py-3 rounded-lg flex items-center bg-gray-500 bg-opacity-10 hover:bg-opacity-20">
							<img className="w-5 h-5 rounded-full" alt="USDC" src="https://raw.githubusercontent.com/parasol-finance/white-paper/main/logo.png" />
										...
										<>
											<div className="flex justify-between items-center justify-between w-full">
												<div className="text-sm">
													...
													<RadioGroup.Description as="span" className={"inline text-gray-400"}>
															<span>
																{route.route.from}
					...
					<div className="space-y-2 md:space-y-4">
						<div className="flex items-center justify-between text-xs">
							...
							<div className="flex cursor-pointer text-black-50 dark:text-white-50 text-xs align-center">
								<span className="min-w-[9.5rem] max-w-full whitespace-nowrap">1 USDC ≈ 8.763594 PSOL</span>
							</div>
						</div>
						...
						<div className="flex items-center justify-between text-xs">
							<div className="text-black-50 dark:text-white-50">Transaction Fee
								<span id="popover-trigger-7" aria-haspopup="dialog" aria-expanded="false" aria-controls="popover-content-7">[?]</span>
							</div>
							<div className="text-black-50 dark:text-white-50">0.000005 SOL</div>
						</div>
						<div className="flex items-center justify-between text-xs">
							<div className="text-black-50 dark:text-white-50">Deposit <span id="popover-trigger-141" aria-haspopup="dialog" aria-expanded="false" aria-controls="popover-content-141">[?]</span>
							</div>
